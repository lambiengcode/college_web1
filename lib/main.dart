                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Titl(text: "Find Nearest Store"),
                                      Titl(text: "Rating & Review"),
                                      Titl(text: "Contact Us"),
                                    ],
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Titl(text: "Hải Phòng:  +84989917877"),
                                      Titl(text: "Đà Nẵng:  +84989917877"),
                                      Titl(text: "Hồ Chí Minh:  +84989917877"),
                                      Titl(text: "Cần Thơ:  +84989917877"),
                                      SizedBox(
                                        height: 40,
                                      ),
                                    ],
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(100),
                            color: kind == 1 ? Color(0xfff0f1fa) : Colors.white,
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(100),
                            color: kind == 2 ? Color(0xfff0f1fa) : Colors.white,
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(100),
                            color: kind == 3 ? Color(0xfff0f1fa) : Colors.white,
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
